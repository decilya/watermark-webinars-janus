...
(function() {
    ...
    videojs.plugin('watermark2', function(settings) {
        ...
        //if user wants watermark2 to be clickable, add anchor elem
        ...
        if (options.clickable && options.url !== "") {
            ...
            //add clickable watermark2 to the player
            player.appendChild(link);
        } else {
            //add normal watermark2 to the player
