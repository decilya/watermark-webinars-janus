window.RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function PeerInitiator(config) {
        ...
        function oldAddRemoteSdp(remoteSdp, cb) {
            ...
            peer.setRemoteDescription(new RTCSessionDescription(remoteSdp), cb, function (error) {
                if (!!connection.enableLogs) {
                   // checkForReloadAndLocationReload();
    ...
    (function (connection) {
        ...
        connection.channel = connection.sessionid = roomid + connection.userid;
                ...
                (function conect() {
                    if ((event.userid)) {
                        (function reCheckRoomPresence() {
                            connection.checkPresence(event.userid, function (isRoomExists) {
                                if (isRoomExists) {
        ...
        connection.onstream = function (e) {
            ...
            if (typeof played !== 'undefined') {
                played.catch(function () { /*** iOS 11 doesn't allow automatic play and rejects ***/
                }).then(function () {
                    setTimeout(function () {
                        e.mediaElement.play();
                    }, 2000);
